...
export function mergeHitosDataForPersist(prev: HitosData, incoming: HitosData): HitosData {
    ...
    const out: HitosData = {
        ...
        limpiezaStatus: inc.limpiezaStatus || p.limpiezaStatus,
...
export function normalizeHitosData(raw?: Partial<HitosData> | null): HitosData {
    ...
    const limpiezaStatusRaw = raw.limpiezaStatus;
    const limpiezaStatus = limpiezaStatusRaw === "si" || limpiezaStatusRaw === "no" ? limpiezaStatusRaw : "";
